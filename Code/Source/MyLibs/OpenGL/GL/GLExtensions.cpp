...
void OpenGL_InitExtensions()
{
    ...
    if (glBindBufferBase == 0)
        glBindBufferBase            = (PFNGLBINDBUFFERBASEPROC)             wglGetProcAddress("glBindBufferBaseEXT");

	glGetUniformBlockIndex		    = (PFNGLGETUNIFORMBLOCKINDEXPROC)		wglGetProcAddress("glGetUniformBlockIndex");
    if (glGetUniformBlockIndex == 0)
        glGetUniformBlockIndex      = (PFNGLGETUNIFORMBLOCKINDEXPROC)       wglGetProcAddress("glGetUniformBlockIndexEXT");

	glUniformBlockBinding			= (PFNGLUNIFORMBLOCKBINDINGPROC)		wglGetProcAddress("glUniformBlockBinding");
    if (glUniformBlockBinding == 0)
        glUniformBlockBinding       = (PFNGLUNIFORMBLOCKBINDINGPROC)        wglGetProcAddress("glUniformBlockBindingEXT");
    ...
    if (glBlendEquation == 0)
        glBlendEquation             = (PFNGLBLENDEQUATIONPROC)              wglGetProcAddress("glBlendEquationgEXT");

    glClearBufferiv                 = (PFNGLCLEARBUFFERIVPROC)              wglGetProcAddress("glClearBufferiv");
    if (glClearBufferiv == 0)
        glClearBufferiv             = (PFNGLCLEARBUFFERIVPROC)              wglGetProcAddress("glClearBufferivEXT");

	glVertexAttribDivisor			= (PFNGLVERTEXATTRIBDIVISORPROC)		wglGetProcAddress("glVertexAttribDivisor");
	if (glVertexAttribDivisor == 0)
		glVertexAttribDivisor		= (PFNGLVERTEXATTRIBDIVISORPROC)		wglGetProcAddress("glVertexAttribDivisorEXT");
	glDrawArraysInstanced			= (PFNGLDRAWARRAYSINSTANCEDPROC)		wglGetProcAddress("glDrawArraysInstanced");
	if (glDrawArraysInstanced == 0)
		glDrawArraysInstanced		= (PFNGLDRAWARRAYSINSTANCEDPROC)		wglGetProcAddress("glDrawArraysInstancedEXT");
